...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        private static readonly string EndpointUri = "https://cosmos-teste-ff.documents.azure.com:443/";
        // The primary key for the Azure Cosmos account.
        private static readonly string PrimaryKey = "TtB3b3UnfzkTRsZ9r2JgsByWXEgvX5rM9qCy080SybtWfd2BeY1HSOXwukvjIJP10rbMcPEkh9RrmEf00HBrCA==";
        ...
        private async Task AddItemsToContainerAsync()
        {
            ...
            try
            {
                ...
                ItemResponse<Family> andersenFamilyResponse = 
                    await this.container.ReadItemAsync<Family>(andersenFamily.Id, new PartitionKey(andersenFamily.LastName));
